...
class RNNModel(nn.Module):
    def __init__(self, hyperparams, device):
        ...
        self.direction=hyperparams["direction"]
    ...
    def save_model(self, path_to_saved_models, mapper,  epochs_trained, args, additional_description=""):
        ...
        modelfolder=join(path_to_saved_models, "model_%s_%s_%idelay_seed_%i_epoch_%i/"%(args.language, args.direction, args.delay, args.seed, epochs_trained))
